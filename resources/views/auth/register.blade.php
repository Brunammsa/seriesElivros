    ...
    <div class="container d-flex justify-content-center ">
        <div class="col-6">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="px-5 col-9 d-flex align-items-center justify-end justify-content-between mt-4">
